...
class BullshitChargeur implements IChargeDonnees {
  ...
  List<Balise> getBalisesPublic() {
    ...
    balises.add(new Balise(48.448914, -68.528186, "Paul-Hubert", "Une des nombreuses écoles secondaire de Rimouski!!"));
